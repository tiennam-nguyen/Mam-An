...
export interface AppServices { catalog:FoodCatalog;meals:MealRepository;glucose:GlucoseRepository;settings:SettingsRepository;thumbnails:ThumbnailRepository;demo:DemoRepository;clock:Clock;session:AnalysisSessionService;liveEnabled:boolean;buildId:string }
