...
export function transition(
  ...
  const next: Partial<
    Record<
      MealAnalysisState,
      Partial<Record<MealAnalysisEvent, MealAnalysisState>>
    >
  > = {
    IDLE: {
    ...
    IMAGE_SELECTED: {
      ANALYZE_REQUESTED: 'ANALYZING',
      MANUAL_REVIEW_READY: 'REVIEW_READY',
    },
    ANALYZING: {
      ANALYSIS_SUCCEEDED: requiresReview ? 'REVIEW_REQUIRED' : 'REVIEW_READY',
    ...
    REVIEW_REQUIRED: {
      DRAFT_CHANGED: requiresReview ? 'REVIEW_REQUIRED' : 'REVIEW_READY',
    },
