...
test('waiting update is offered, preserves unsaved meal, and activates after save', async ({ page }) => {
  ...
  try {
    ...
    const update = page.getByRole('button', { name: 'Tải phiên bản mới', exact: true });
